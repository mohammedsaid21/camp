...
export const STATS = [
  { value: 10, label: "مشاريع موثّقة من المخيم" },
  { value: 120, label: "يصلها الخبز بشكل دوري" },
  { value: 200, prefix: "+", label: "صائم تم افطارهم" },
] as const;

export const STATS_NOTE =
  "الأرقام من تنفيذ المشاريع المعروضة أدناه، داخل مخيم نسائم الرحمة.";
